...
function StepTracker({ currentStep, progress }) {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-between items-center text-xs mb-1.5">
          <span className="font-semibold text-citi-dark-blue">
            Step {currentStep}: {ONBOARDING_STEPS.find((s) => s.step === currentStep)?.name || "Complete"}
          </span>
...
export default function ChatWindow() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] max-w-4xl mx-auto bg-gray-50 shadow-inner">
      ...
      <StepTracker currentStep={currentStep} progress={progress} />
